...
export default {
    ...
    setup(){
       let data = [{title:"容器",html:"<fd-layout></fd-layout>"},{title:"标签表格",html:"<fd-tabs  v-model='activeName'><fd-tab-pane label='a' name='a'>内容a</fd-tab-pane><fd-tab-pane label='b' name='b'>内容b</fd-tab-pane></fd-tabs>"},{title:"按钮",html:"<fd-button>无标题</fd-button>"},{title:"链接",html:"<a href=''>无标题</a>"}];
       let activeName = "a"
        let addComponent = (el)=>{
